...
//
//    //插入
//    public RBTreeNode<T> insert(T t, RBTreeNode<T> node){
//        if(null == node){
//            return new RBTreeNode<T>(t, false);
//        }
...
//    }
    ...
    public T find(T value) {
        ...
        while (dataRoot != null) {
            int cmp = dataRoot.getData().compareTo(value);
            if (cmp < 0) {
                dataRoot = dataRoot.getRight();
            } else if (cmp > 0) {
                dataRoot = dataRoot.getLeft();
            } else {
                return dataRoot.getData();
            }
        }
        return null;
    }
    ...
    private T addNode(RBTreeNode<T> node) {
        ...
        if (root.getLeft() == null) {
            ...
            int cmp = x.getData().compareTo(node.getData());
    ...
    private RBTreeNode<T> findParentNode(RBTreeNode<T> x) {
        ...
        while (child != null) {
            int cmp = child.getData().compareTo(x.getData());
            if (cmp == 0) {
                return child;
            }
            if (cmp > 0) {
